export const RadialPurpleBlurCircle = () => (
  <div className="pointer-events-none fixed bottom-auto left-auto right-0 top-0 -z-0 h-[700px] w-[700px] -translate-x-[10%] translate-y-[10%] rounded-full bg-[rgba(173,109,244,0.5)] opacity-50 blur-[80px] dark:opacity-20" />
);

export const RadialGradientScreen = () => (
  <div className="pointer-events-none fixed left-0 top-0 -z-0 h-screen w-screen bg-[radial-gradient(ellipse_80%_80%_at_50%_-20%,rgba(120,119,198,0.3),rgba(255,255,255,0))]" />
);
